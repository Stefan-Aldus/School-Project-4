...
{
    try {
        $delcustomer = $db->prepare("DELETE FROM country WHERE idcountry = :id"); // Replace 'country_id' with the actual column name
    ...
    echo '<script>window.location.replace("shw-all-country.php")</script>';
}
